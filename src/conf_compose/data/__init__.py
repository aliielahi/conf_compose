...
from .multiple_choice import CommonsenseQA
from .numeric import GSM8K, SVAMP

TASKS = {task.name: task for task in (GSM8K, SVAMP, MATH500, CommonsenseQA, BoolQ, ProntoQA)}
...
__all__ = ["Answer", "Example", "Task", "GSM8K", "SVAMP", "MATH500", "CommonsenseQA", "BoolQ", "ProntoQA",
           "TASKS", "get_task"]
